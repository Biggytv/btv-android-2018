...
*/
    ...
    /////////////SHOW INFO START///////
    function refreshInfo(channel) {
 
        var xhr = Titanium.Network.createHTTPClient();
        xhr.open("GET",
            "https://cms.biggytv.com/mobile_resources/btvnowPlaying_web.php?cid=" +
            channel);
        xhr.setTimeout(5000);
        xhr.send();
        xhr.onload = function() {
    ...
    function channelLoad() {
        ...
        channelList.onload = function() {
            ...
            for (var i = 0; i < channelJSON.length; i++) {
                ...
                channelRow.add(channelImage);
                channelRow.add(channelLabel);
                channelRow.add(channelOnnow);
        ...
        channelTable.addEventListener('click', function(e) {
            ...
            refreshInfo(e.rowData.playlist);
